...
class SquareList extends (PureComponent || Component) {
  static propTypes = {
    classback: PropTypes.func,
  }
  showItem = data => (
    <div onClick={() => this.props.classback(data.querystr_map, data.name)} className="am-grid-item-inner-content column-num-4">
