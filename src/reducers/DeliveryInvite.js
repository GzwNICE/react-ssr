...
import {
  DELIVERY_HAS_INVITE,
  DELETE_DELIVERY_INVITE,
  DELETE_INVITE_PAGE_UNMOUNT,
} from '../actions/DeliveryInvite'
...
export default (state = initState, action) => {
  switch (action.type) {
    case DELIVERY_HAS_INVITE:
      return {
        ...state,
        list: [...action.data],
      }
    case DELETE_DELIVERY_INVITE:
      return {
        ...state,
    ...
    case DELETE_INVITE_PAGE_UNMOUNT:
      return {
        ...state,
