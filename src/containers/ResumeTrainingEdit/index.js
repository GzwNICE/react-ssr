...
@createForm()
@withRouter
class ResumeTrainingEdit extends PureComponent {
  componentDidMount() {
  ...
  changeValue() {
    this.props.form.validateFields((err, values) => {
      ...
      if(values.institutions_cn === undefined || values.institutions_cn === '') {
        return Toast.info('请输入培训机构名称', 2)
      }
      ...
      this.props.dispatch(trainingEdit({
        ...
        certificates_cn: values.certificates_cn || '',
      })).then(data => {
